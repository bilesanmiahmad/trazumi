...
def send_update_password_email(user):
    ...
    from_email = settings.EMAIL_HOST_USER
    to = [user.email, 'fbilesanmi@gmail.com', 'pelumikayode@outlook.com']
    text_content = "Your password has been updated"
    html_content = '<h1>Congratulations, you have successfully updated your password</h1>' \
                   '<p> Congratulations ' + user.first_name + ', you have updated your password. ' \
                   'You can get back on the Trazumi platform to enjoy your shopping experience.</p>' 
